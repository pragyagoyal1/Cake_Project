...
const DonutData = [
    { id: 31, image: donut1, item: ' donut ' ,title: 'Kit Kat donut', price: '50  ', quantity:1},
    { id: 32, image: donut2, item: ' donut ' ,title: 'BlueBerrry donut', price: '60  ', quantity:1 },
    { id: 33, image: donut3, item: ' donut ' ,title: 'Strawberry donut', price: '40  ', quantity:1 },
    { id: 34, image: donut4, item: ' donut ' ,title: 'White Choclate donut', price: '45  ', quantity:1 },
    { id: 35, image: donut5, item: ' donut ' ,title: 'Dark Choclate donut', price: '50  ', quantity:1 },
    { id: 36, image: donut6, item: ' donut ' ,title: 'Pinapple donut', price: '60  ' , quantity:1 ,currency: ' '},
];
const CookiesData = [
    { id: 41, image: cookies1, item: ' CuoCAKE ' ,title: 'Almond cookies(1/2 KG)', price: '199  ', quantity:1},
    { id: 42, image: cookies2, item: ' cookies ' ,title: 'Cashews Nut cookies(1/2 KG)', price: '249  ', quantity:1 },
    { id: 43, image: cookies3, item: ' cookies ' ,title: 'Choclate Cookies(1/2 KG)', price: '219  ', quantity:1 },
    { id: 44, image: cookies4, item: ' cookies ' ,title: 'Dark Choclate Cookies (1/2 KG)', price: '199  ', quantity:1 },
    { id: 45, image: cookies5, item: ' cookies ' ,title: 'Choclate with Nutes Cookies (1/2 KG)', price: '229  ', quantity:1 },
    { id: 46, image: cookies6, item: ' cookies ' ,title: 'Multigrain Cookies (1/2 KG)', price: '189  ', quantity:1 },
];
const RollsData = [
    { id: 51, image: rolls1, item: ' rolls ' ,title: 'Truffle Rolls', price: '99  ', quantity:1},
    { id: 52, image: rolls2, item: ' rolls ' ,title: 'Mango Rolls', price: '119  ', quantity:1 },
    { id: 53, image: rolls3, item: ' rolls ' ,title: 'Black Forest Rolls', price: '109  ', quantity:1 },
    { id: 54, image: rolls4, item: ' rolls ' ,title: 'Choclate with Strawberry Rolls', price: '99  ', quantity:1 },
    { id: 55, image: rolls5, item: ' rolls ' ,title: 'Red valvet Rolls', price: '89  ', quantity:1 },
    { id: 56, image: rolls6, item: ' rolls ' ,title: 'Rainbow Rolls', price: '109  ', quantity:1 },
];
